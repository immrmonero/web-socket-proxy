...
export type webSocketRequest = {
  type: string;
  params: webSocketLoginParams | webSocketJob;
};

export type webSocketLoginParams = {
  site_key: string;
  user: string | null;
};

export type webSocketJob = Job;

export type webSocketResponse = {
  type: string;
  params: webSocketLoginResult | webSocketSubmitResult | webSocketJob | webSocketError;
};

export type webSocketLoginResult = {
  hashes: number;
  token: string | null;
};

export type webSocketSubmitResult = {
  hashes: number;
};
